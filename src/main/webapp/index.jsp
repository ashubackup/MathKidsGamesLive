...
<!-- 						</div> -->
				...
				%>
					...
					<h3 class="cus-head mt-3">Discover Games for Kids</h3>
				</div>
					...
					<ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
					 ...
					 try{
						...
						{
						System.out.println("tbl_cat category_name is : "+ name);
					...
					<!-- Cartoon......comming -->
						<li class="nav-item" role="presentation"><%-- <a class="nav-link"
							...
							aria-controls="pills-<%=name.substring(0, 3)%>"
							aria-selected="false"
							onclick="savesession('<%=name.substring(0, 3)%>')">9805702978</a></li> --%>
						...
						<div class="tab-pane fade <%=status%>"
							...
							while(rs.next())
							{
								...
								}else
								{
									while(rs.next())
									{
										// game comming from here tbl_games_2
										System.out.println("c...c");
										
										String gamename=rs.getString("gamename");
										String gameid=rs.getString("gameid");
										String imgurl=rs.getString("imgurl");
										String gameurl = rs.getString("gameurl");
										System.out.println(gameurl);//game play link
										%>
										<div class="col-md-6 col-12 my-2">
											<div class="video-box position-relative mb-0">
											<%-- 	<a href="video?id=<%=gameid%>"> --%>
												<a href="<%=gameurl%>"> <img src="<%=imgurl%>" alt=""
													class="img-fluid"> <i class="fa fa-play-circle"
													aria-hidden="true"></i>
												</a>
												<%-- <p class="text-center text-deco"><%=vname%></p> --%>
												<p class="text-center text-deco"><%=gamename%></p>
											</div>
